...
namespace BankApplication
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine($"Account {i + 1} balance: {accounts[i].Balances:C}");
